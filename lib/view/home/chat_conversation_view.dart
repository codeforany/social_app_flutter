...
import 'package:social_app/common_widget/chat_date_bubbles.dart';
import 'package:social_app/common_widget/chat_text_bubbles.dart';
          ...
          itemBuilder: (context, index) {
            ...
            if (cObj["is_text"] as bool? ?? false) {
              ...
              return ChatTextBubbles(
                cObj: cObj,
                uObj: (cObj["is_sender"] as bool? ?? false ) ? {"image":"assets/img/user_profile.png"} : widget.uObj,
                isLeft: cObj["is_sender"] as bool? ?? false,
              );
            } else {
              // Date Row
              return ChatDateBubble(date: cObj["message"] as String? ?? "" ,);
            }
          }),
